  ...
  return (
    <div className="space-y-6">
      ...
      {previewUrl && (
        <Card>
          <CardHeader>
            <CardTitle>Uploaded Blood Report</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="border rounded-md overflow-hidden">
              <img src={previewUrl} alt="Blood Report" className="w-full h-auto" />
            </div>
          </CardContent>
        </Card>
      )}
      ...
      {analyzing && (
        <div className="py-8 text-center">
          ...
          <p className="text-lg font-medium">Analyzing blood report...</p>
